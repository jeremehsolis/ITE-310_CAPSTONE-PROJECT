...
$db = mysqli_connect('localhost','root','','schedulingSystem');
	$check1 = mysqli_query($db, "SELECT * FROM `login` WHERE `user_id`='$_SESSION[user_id]'")or die(mysqli_error());
			
    
          
				$fetch1 = mysqli_fetch_array($check1);
                
                $userde =$fetch1['username'];
                 $_SESSION['userde'] = $userde;
                 $_SESSION['userde1'] = $userde;
...
<html lang="en">
  ...
  <header class="d-flex flex-wrap justify-content-center py-3 no-gutters my-auto mx-auto">
    ...
    <h1 class="text-center fw-bold" style="color: goldenrod;">DASHBOARD</h1>
        ...
        <a href="subjectManagement1.php" class="text-center px-5 py-2 col text-decoration-none text-dark">
          <img src="sched.png" class="img-fluid" alt="" style="width: 140px; height: 140px;"><p class="fw-bold">SCHEDULE MANAGEMENT</p></a>
        <a href="plotmg1.php" class="text-center px-5 py-2 col text-decoration-none text-dark">
